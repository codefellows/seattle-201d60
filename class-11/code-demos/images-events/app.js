...
// Globals
var goatImageSectionElem = document.getElementById('all_goats');
var leftGoatImageElem = document.getElementById('left_goat_img');
var rightGoatImageElem = document.getElementById('right_goat_img');
var leftGoatCaptionElem = document.getElementById('left_goat_h2');
var rightGoatCaptionElem = document.getElementById('right_goat_h2');
...
var renderNewGoats = function (leftIndex, rightIndex){
  leftGoatImageElem.src = GoatPicture.allImages[leftIndex].url;
  rightGoatImageElem.src = GoatPicture.allImages[rightIndex].url;
  leftGoatCaptionElem.textContent = GoatPicture.allImages[leftIndex].name;
  rightGoatCaptionElem.textContent = GoatPicture.allImages[rightIndex].name;
};
...
var handleClickOnGoat = function(event){
  ...
  if(totalClicks === 5){
    goatImageSectionElem.removeEventListener('click', handleClickOnGoat);
...
goatImageSectionElem.addEventListener('click', handleClickOnGoat);
